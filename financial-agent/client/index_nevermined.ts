/**
 * @fileoverview Financial Agent Client - x402 Payment Flow Demo
 *
 * This client demonstrates how to interact with a protected financial agent
...
/**
 * Sends a question to the protected financial agent using the x402 payment flow
